...
export const abilitiesProperties: abilitiesPropertiesTypes[] = [
    ...
    {abilityName: "intelligence", abilityChecks: ["Arcana", "History", "Investigation", "Nature", "Religion"]},
    {abilityName: "wisdom", abilityChecks: ["Animal Handling", "Insight", "Medicine", "Perception", "Survival"]},
    {abilityName: "charisma", abilityChecks: ["Deception", "Intimidation", "Performance", "Persuasion"]}
];